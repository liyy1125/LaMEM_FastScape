...
struct FastScapeLib
{
  ...
  PetscScalar rangeY_end; 
	...
	Vec vx_fs, vy_fs, vz_fs, gtopo_fs, gtopo_collect;
...
PetscErrorCode Extended2DRefine(FastScapeLib*, PetscScalar*, PetscScalar*);
...
PetscErrorCode Pass2DValueRefine(FastScapeLib*, PetscScalar*, PetscScalar*);
PetscErrorCode PassValue3D(FastScapeLib*, PetscScalar*, PetscScalar*);
PetscErrorCode PassValueNonUniformGrid(FastScapeLib*, PetscScalar*, PetscScalar*);
